      ...
      <div class="row">
        ...
        <div class="col-lg-6 align-self-center">
          <div class="content">
            <h1><?= $this->Html->image('bells.png', ['class' => 'mr-1', 'style' => 'height: 40px; vertical-align: text-top;']) ?>Natal Solidário</h1>
